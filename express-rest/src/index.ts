...
app.get('/api/v1/users', (req: any, res: any) => res.json(users.getAllUsers()));

app.get('/api/v1/users/:user_id', (req: any, res: any) => {
...
app.delete('/api/v1/users/:user_id', (req: any, res: any) => {
...
app.post('/api/v1/users', (req: any, res: any) => {
